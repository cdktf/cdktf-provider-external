// https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs
...
export class ExternalProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ExternalProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/external/2.3.3/docs#import import section} in the documentation of this resource for the id to use
